...
IkarusPropertyDeleteV1Result ikarus_property_delete_v1_impl(Project * project, Id property, IkarusPropertyDeleteV1Flags flags);
...
IkarusPropertyGetPageV1Result ikarus_property_get_page_v1_impl(Project * project, Id property, IkarusPropertyGetPageV1Flags flags);

IkarusPropertyGetTypeV1Result ikarus_property_get_type_v1_impl(Project * project, Id property, IkarusPropertyGetTypeV1Flags flags);
